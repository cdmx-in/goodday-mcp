...
async def make_goodday_request(endpoint: str, method: str = "GET", data: dict = None) -> dict[str, Any] | None:
...
Status: {task.get('status', {}).get('name', 'N/A')}
Project: {task.get('project', {}).get('name', 'N/A')}
Assigned To: {task.get('assignedToUser', {}).get('name', 'Unassigned')}
...
def format_project(project: dict) -> str:
    """Format a project into a readable string."""
    return f"""
Project ID: {project.get('id', 'N/A')}
Name: {project.get('name', 'N/A')}
Health: {project.get('health', 'N/A')}
Status: {project.get('status', {}).get('name', 'N/A')}
Start Date: {project.get('startDate', 'N/A')}
End Date: {project.get('endDate', 'N/A')}
Progress: {project.get('progress', 0)}%
Owner: {project.get('owner', {}).get('name', 'N/A')}
"""

def format_user(user: dict) -> str:
    """Format a user into a readable string."""
    return f"""
